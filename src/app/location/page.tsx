...
const page = () => {
    return (
        <div>
            <div className='bg-[url("/banner.png")] min-h-64 md:min-h-80 lg:min-h-[400px] xl:min-h-[420px] bg-center bg-cover bg-no-repeat'>
                <div className='container'>
                    <div className='flex flex-col justify-center items-center p-5 md:p-12 lg:p-16 xl:p-20'>
                        <h2 className='text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-figtree font-black text-[#0f3732] my-2 md:my-5 text-center leading-tight'>Find Clients Near You Faster!</h2>
            ...
            <div className='container'>
                <div className='rounded-xl p-5 mx-auto -mt-32 mb-10'>
                    <LocationForm />
                </div>
            </div>
