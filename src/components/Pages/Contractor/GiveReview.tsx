    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit(handleFormSubmit)}>
                <textarea rows={6} {...register("message", { required: true, minLength: { value: 10, message: "message minimum 10 character" } })} className={`rounded-lg bg-gray-100 w-full shadow border ${errors?.message ? "border-danger" : "border-stroke"} outline-0 p-3 font-figtree font-medium text-base`}>
                </textarea>
