    ...
    return (
        <div>
            ...
            <motion.h2
                ...
                {/* -------------md screen ------------- */}
                <span className='hidden md:block'>Get jobs done quickly within our active working community, with the lowest <br /> and best quotes nationwide! <Link href='/' className='text-[#e1272899]'>Post Your Job.</Link></span>
                {/* -------------small screen ----------- */}
                <span className='md:hidden'>Get jobs done quickly within our active working community, with the lowest and best quotes nationwide! <Link href='/' className='text-[#e1272899]'>Post Your Job.</Link></span>
            </motion.h2>
        </div>
    );
};
